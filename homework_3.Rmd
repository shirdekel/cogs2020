...
gb <- ggplot(d, aes(y, fy)) +
  ...
  annotate("text", x=3, y=0.21, label="P(Y<=y)") +
...
<!-- **(f)** The plots above were generated from the data.table `d` -->
<!-- which is defined in the above code chunk. This data.table contains -->
<!-- three columns: -->

<!--   * `exp` indicates the experiment (we ran 1000 of them) -->

<!--   * `n` indicates the number of samples drawn from $X$ in  -->
<!--   a given experiment.  -->

<!--   * `x` contains the sample mean obtained in experiment `exp`  -->
<!--   with sample size `n`. -->

<!-- ```{r} -->
<!-- # inspect d by printing to console -->
<!-- d -->
<!-- ``` -->

<!--   * Starting with `d`, create a new data.table named `dd` that  -->
<!--   contains the mean of `x` per level of `n`. Please be sure that -->
<!--   you set the column names of `dd` to `n` and `x`, where `x`  -->
<!--   the mean values just computed. The resulting data.table should -->
<!--   look eactly as follows. -->
...
<!-- ```{r} -->
<!-- # inspect dd by printing to console -->
<!-- dd -->
<!-- ``` -->

<!-- How does increasing $n$ influence your sample mean -->
