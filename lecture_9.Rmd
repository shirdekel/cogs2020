...
| :---------: | :-------------:                                                  | :-------------:                                                  | :-------------:                     |
| Dose 1      | $\bar{y}_{11\bullet} = \frac{y_{111}+y_{112}+\ldots+y_{11n}}{n}$ | $\bar{y}_{12\bullet} = \frac{y_{121}+y_{122}+\ldots+y_{12n}}{n}$ | $\bar{y}_{\bullet 1 \bullet}$       |
| Dose 2      | $\bar{y}_{21\bullet} = \frac{y_{211}+y_{212}+\ldots+y_{11n}}{n}$ | $\bar{y}_{22\bullet} = \frac{y_{221}+y_{222}+\ldots+y_{22n}}{n}$ | $\bar{y}_{\bullet 2 \bullet}$       |
...
- $n_{total} =$ number of observations at each treatment
$\times$ dose combination level
...
n_treatment <- d[, length(unique(treatment))]
n_dose <- d[, length(unique(dose))]
