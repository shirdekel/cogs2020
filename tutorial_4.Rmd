...
* Do some almost real-world data wrangling. 

* Understand how to use the `list.files` function.

* Understand the basics of `for` loops.

* Understand how to create a `list` of `data.table` objects
and how to convert that `list` into a single combined
`data.table` using the `rbindlist` function.
...
plenty but you can download the all the `.csv` files if you
like). It doesn't matter which files they are so long as
they are `.csv` data files all with identical format.
...
`tutorial_4_notes.R`, and save it in your `cogs2020` folder.
...
* Visualise this data in as many other ways as you can.
