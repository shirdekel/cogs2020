...
From here -- `https://rstudio.cloud/learn/primers/3` --  do
the following tutorials:

* `https://rstudio.cloud/learn/primers/3.2`
* `https://rstudio.cloud/learn/primers/3.3`
* `https://rstudio.cloud/learn/primers/3.4`
* `https://rstudio.cloud/learn/primers/3.5`
* `https://rstudio.cloud/learn/primers/3.6`
* `https://rstudio.cloud/learn/primers/3.8`
