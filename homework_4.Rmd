...
not divide evenly into the number of rows in `d`, so you
will have to be careful and clever in dealing with this.
However you deal with it, the final trials in `d` should
correspond to a block value of 82.
