...
any single outcome is zero. The distribution is represents
...
## Using pdf (not exact)
p <- sum(dnorm(seq(-5, 1, .1), mu, sig)*.1)
p
...
## Using pmf (exact)
p <- sum(dbinom(8:n, n, p))
p

## using cdf (exact)
p <- pbinom(9, n, p, lower.tail=F)
p
```
</div>
