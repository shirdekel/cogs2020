...
where $D$ can have any distribution whatsoever.
Then,

$\boldsymbol{Y} \sim \mathcal{N}(\mu_{Y}, \sigma_{y}^2)$

where $\mathcal{N}$ stands for a *Normal* distribution.

It turns out that we can show:

$\mu_{Y} = n \mu_{X}$ 

$\sigma_{y}^2 = n \sigma_{X}^2$

This leads to the following statements about the **distribution 
of sample means** defined by the random variable $\bar{X}$.

$\bar{X}=\frac{X_1 + X_2 + \ldots + X_n}{n}$

$\mu_{\bar{X}} = \mu_{X}$

$\sigma_{\bar{X}}^2 = \frac{\sigma_{\bar{X}}^2}{n}$

As a matter of terminology, $\sigma_{\bar{X}}=\frac{\sigma_{X}}{\sqrt{n}}$
